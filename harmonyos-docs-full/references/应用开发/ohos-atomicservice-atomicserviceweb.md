...
| nestedScroll 15+ | NestedScrollOptions \| NestedScrollOptionsExt | 否 | @Prop | 设置嵌套滚动选项。 元服务API： 从API version 15开始，该接口支持在元服务中使用。 |
...
| 类型 | 说明 |
| --- | --- |
| string | 默认用户代理。默认User-Agent定义与使用场景请参考 User-Agent开发指导 。 |
...
| 类型 | 说明 |
| --- | --- |
| string | 用户自定义代理信息。默认User-Agent定义与使用场景请参考 User-Agent开发指导 。 |

...
## RenderProcessNotRespondingReason 12+
...
| RETURN_TO_UICONTEXT 22+ | 3 | Web组件的软键盘避让行为将跟随UIcontext设置的 KeyboardAvoidMode 模式，Web组件不再处理组件的避让。 |

...
| int32_t OH_ImagePacker_Release(ImagePacker_Native* native) | 释放native层编码器对象 ImagePacker_Native 。 此API不用于释放JavaScript原生API ImagePacker对象，它用于释放native层对象ImagePacker_Native。 |
...
[OH_ImagePacker_Release](/consumer/cn/doc/harmonyos-references/capi-image-packer-mdk-h#oh_imagepacker_release)
...
[OH_ImagePacker_PackToFile](/consumer/cn/doc/harmonyos-references/capi-image-packer-mdk-h#oh_imagepacker_packtofile)
...
[OH_ImagePacker_PackToData](/consumer/cn/doc/harmonyos-references/capi-image-packer-mdk-h#oh_imagepacker_packtodata)
...
通过调用[OH_ImagePacker_InitNative](/consumer/cn/doc/harmonyos-references/capi-image-packer-mdk-h#oh_imagepacker_initnative)解析。
...
[OH_ImagePacker_InitNative](/consumer/cn/doc/harmonyos-references/capi-image-packer-mdk-h#oh_imagepacker_initnative)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| src | ArrayBuffer | 是 | 缓冲区，函数执行时会将该缓冲区中的图像像素数据写入到PixelMap。缓冲区大小由 getPixelBytesNumber 接口获取。 |
...
## createCroppedAndScaledPixelMap 22+
...
## createCroppedAndScaledPixelMapSync 22+

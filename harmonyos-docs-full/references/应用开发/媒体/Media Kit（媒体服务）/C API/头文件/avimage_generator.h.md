...
| OH_AVErrCode OH_AVImageGenerator_FetchFrameByTime(OH_AVImageGenerator* generator, int64_t timeUs, OH_AVImageGenerator_QueryOptions options, OH_PixelmapNative** pixelMap) | 从视频资源中获取指定时间点视频帧。 此函数必须在 OH_AVImageGenerator_SetFDSource 之后调用。 |
...
此函数必须在[OH_AVImageGenerator_SetFDSource](/consumer/cn/doc/harmonyos-references/capi-avimage-generator-h#oh_avimagegenerator_setfdsource)之后调用。

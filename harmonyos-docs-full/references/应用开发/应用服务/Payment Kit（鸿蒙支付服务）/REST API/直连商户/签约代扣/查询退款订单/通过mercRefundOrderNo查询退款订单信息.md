...
```
GET / api / v1 / aggr / transactions / refunds / merc - orders /{ mercRefundOrderNo } HTTP / 1.1 Content - Type : application / json ; charset = UTF - 8 PayMercAuth : { "callerId" : "10132120***" , "traceId" : "202305151501065647518" , "time" : 1684134066769 , "authId" : "120291744647139***" , "headerSign" : "Xk8v3RllpGjzfhfKW79Tql********************pIvq22r1v6/Xi/fp9wn95kC59Rouun3cAAckpr62PSy2n6I32uJ9WjL8K4ZvwaE=" , "bodySign" : "bo3c++ml4oNAeByL2K7dVZ0MUuvnb+TJ9jh3BhKQot9W47mVFdDEVO1******************HQqYHsjoyuXGw=" }
```
...
```
HTTP / 1.1 200 OK Content - Type : application / json ; charset = UTF - 8 { "resultCode" : "000000" , "resultDesc" : "Success." , "sign" : "MEUCID/OdfJbB9urDnW/TP4t5QSw********************YKtKUYW8l3dWHJwtM7LZP6cDauVa75+6WlA=" , "sysRefundOrderNo" : "12407030900270084914518***" , "mercRefundOrderNo" : "czl0012024070914***" , "refundOrderStatus" : "REFUND_SUCCESS" , "finishTime" : "2023-05-15T14:42:09.000+0800" , "promotionRefundAmount" : 0 , "refundAmount" : 2 , "payerRefundAmount" : 2 , "currency" : "CNY" , "payload" : "example-payload" }
```

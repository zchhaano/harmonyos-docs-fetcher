...
```
GET / api / v1 / aggr / transactions / refunds / orders /{ sysRefundOrderNo } HTTP / 1.1 Content - Type : application / json ; charset = UTF - 8 PayMercAuth : { "callerId" : "10132120***" , "traceId" : "202305151501075707669" , "time" : 1684134067480 , "authId" : "120291744647139***" , "headerSign" : "p9e6EvvWnVW/Q********************o6Run7iCj1mWYBYJIPB75/UrhP0aBflpW1J8Sf8VUt6orCWk=" , "bodySign" : "haZnDZSsB/ed+BBnXhv5lPKR********************H8JJ+7uNwoEYO3lps=" }
```
...
```
HTTP / 1.1 200 OK Content - Type : application / json ; charset = UTF - 8 { "resultCode" : "000000" , "resultDesc" : "Success." , "sign" : "MEUCIQCEA/HVCjAFReiy59wGUp0zQ********************IxmlIIv2zaKH3e6YfxkL94=" , "sysRefundOrderNo" : "12407030900270084914518***" , "mercRefundOrderNo" : "czl0012024070914***" , "refundOrderStatus" : "REFUND_SUCCESS" , "finishTime" : "2023-05-15T14:42:09.000+0800" , "promotionRefundAmount" : 0 , "refundAmount" : 2 , "payerRefundAmount" : 2 , "currency" : "CNY" , "payload" : "example-payload" }
```

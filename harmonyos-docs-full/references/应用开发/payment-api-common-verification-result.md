...
| --- | --- |
| 接口方向 | 开发者服务器 -> 华为支付服务器 |
| 接口URL | https://petalpay-developer.cloud.huawei.com.cn/api/v1/realname/verification/result 说明 元服务接口调用一致。 |
...
| 参数 | 是否必选 | 类型 | 说明 |
| --- | --- | --- | --- |
| verifyResultId | 是 | String | 实名信息验证ID。 应用端接口 返回的用户实名信息验证ID。 |

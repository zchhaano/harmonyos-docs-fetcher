...
## usbManager.usbControlTransfer 12+
...
## usbManager.usbSubmitTransfer 18+
...
## usbManager.usbCancelTransfer 18+
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| transfer | UsbDataTransferParams | 是 | 在取消传输的接口中，只需要填充 USBDevicePipe 和 USBEndpoint 即可。 |
...
## usbManager.hasAccessoryRight 14+
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| accessory | USBAccessory | 是 | USB配件，需要通过 getAccessoryList 获取。 |
...
## usbManager.requestAccessoryRight 14+
...
## usbManager.cancelAccessoryRight 14+
...
## usbManager.getAccessoryList 14+
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| accessoryHandle | USBAccessoryHandle | 是 | USB配件句柄。需要通过 openAccessory 获取。 |
...
| type | number | 否 | 否 | 端点类型。取值见 UsbEndpointTransferType |

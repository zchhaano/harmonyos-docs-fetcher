...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| OH_Drawing_Array* OH_Drawing_TypographyGetTextLines(OH_Drawing_Typography* typography) | - | 获取排版对象的文本行数组。文本行数组中包含一个或多个文本行对象。不再需要 OH_Drawing_Array 时，请使用 OH_Drawing_DestroyTextLines 接口释放该对象的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| OH_Drawing_Typography * typography | 指向排版对象 OH_Drawing_Typography 的指针。 |
...
| 类型 | 说明 |
| --- | --- |
| OH_Drawing_Array * | 指向文本行数组 OH_Drawing_Array 的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| OH_Drawing_Array * lines | 指向文本行数组 OH_Drawing_Array 的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| OH_Drawing_TextLine * line | 指向文本行对象 OH_Drawing_TextLine 的指针。 |
...
| 类型 | 说明 |
| --- | --- |
| OH_Drawing_TextLine * | 指向指定索引处的文本行对象 OH_Drawing_TextLine 的指针。 |
...
| 类型 | 说明 |
| --- | --- |
| OH_Drawing_Array * | 指向文本渲染单元 OH_Drawing_Run 数组 OH_Drawing_Array 的指针，不再需要 OH_Drawing_Array 时，请使用 OH_Drawing_DestroyRuns 释放该对象的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| OH_Drawing_Array * runs | 指向文本渲染单元 OH_Drawing_Run 数组 OH_Drawing_Array 的指针。 |
...
| 类型 | 说明 |
| --- | --- |
| OH_Drawing_Run * | 指向指定索引处的文本渲染单元对象 OH_Drawing_Run 的指针。 |
...
| --- | --- |
| OH_Drawing_TextLine * line | 指向文本行对象 OH_Drawing_TextLine 的指针。 |
| OH_Drawing_Canvas * canvas | 指向绘制的目标画布 OH_Drawing_Canvas 。 |
...
| 类型 | 说明 |
| --- | --- |
| OH_Drawing_TextLine * | 返回指向截断的文本行对象 OH_Drawing_TextLine 指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| OH_Drawing_TextLine * line | 指向文本行对象 OH_Drawing_TextLine 的指针。height = ascent + descent + leading。 |
...
| 类型 | 说明 |
| --- | --- |
| OH_Drawing_Rect * | 指向文本行对象的图像边界 OH_Drawing_Rect 的指针，不再需要 OH_Drawing_Rect 时，请使用 OH_Drawing_RectDestroy 接口释放该对象的指针。 |
...
| --- | --- |
| OH_Drawing_TextLine * line | 指向文本行对象 OH_Drawing_TextLine 的指针。 |
| OH_Drawing_Point * point | 指向要查找索引的位置 OH_Drawing_Point 指针。 |
...
| --- | --- |
| OH_Drawing_TextLine * line | 指向文本行对象 OH_Drawing_TextLine 的指针。 |
| Drawing_CaretOffsetsCallback callback | 用户自定义函数 Drawing_CaretOffsetsCallback 。 |

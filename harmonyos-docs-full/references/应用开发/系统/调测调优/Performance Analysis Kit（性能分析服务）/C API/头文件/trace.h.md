...
| void OH_HiTrace_SetFlags(HiTraceId *id, int flags) | - | 设置跟踪标志位到 HiTraceId 中。 |
...
| int32_t OH_HiTrace_UnregisterTraceListener(int32_t index) | - | 注销应用trace捕获开关通知回调。 使用 OH_HiTrace_RegisterTraceListener 返回的回调索引，注销该索引关联的回调函数。 |
...
| int flags | 跟踪标志组合，见 HiTrace_Flag 。 |
...
| 参数项 | 描述 |
| --- | --- |
| const HiTraceId *id | 要设置的 HiTraceId 。 |
...
| 参数项 | 描述 |
| --- | --- |
| HiTrace_Communication_Mode mode | 跟踪通信模式，见 HiTrace_Communication_Mode 。 |
| HiTrace_Tracepoint_Type type | 跟踪信息类型，见 HiTrace_Tracepoint_Type 。 |
| const HiTraceId *id | 实施信息埋点操作的 HiTraceId 。 |
...
| 参数项 | 描述 |
| --- | --- |
| const HiTraceId *id | 需要判断是否有效的 HiTraceId 。 |
...
| 类型 | 说明 |
| --- | --- |
| bool | true： HiTraceId 有效；false： HiTraceId 无效。 |
...
| 参数项 | 描述 |
| --- | --- |
| const HiTraceId *id | 需要判断指定跟踪标志是否启用的 HiTraceId 。 |
| HiTrace_Flag flag | 指定的跟踪标志，见 HiTrace_Flag 。 |
...
| 类型 | 说明 |
| --- | --- |
| bool | true： HiTraceId 已启用flag；false： HiTraceId 未启用flag。 |
...
| 参数项 | 描述 |
| --- | --- |
| const HiTraceId *id | 需要启用指定跟踪标志的 HiTraceId 。 |
| HiTrace_Flag flag | 指定的跟踪标志，见 HiTrace_Flag 。 |
...
| 参数项 | 描述 |
| --- | --- |
| const HiTraceId *id | 需要获取跟踪标志位的 HiTraceId 。 |
...
| 参数项 | 描述 |
| --- | --- |
| HiTraceId *id | 需要设置跟踪标志位的 HiTraceId 。 |
| int flags | 指定的跟踪标志位，见 HiTrace_Flag 。 |
...
| 参数项 | 描述 |
| --- | --- |
| const HiTraceId *id | 需要获取跟踪链ID的 HiTraceId 。 |
...
| 参数项 | 描述 |
| --- | --- |
| HiTraceId *id | 需要设置跟踪链ID的 HiTraceId 。 |
...
| 参数项 | 描述 |
| --- | --- |
| const HiTraceId *id | 需要获取分支ID的 HiTraceId 。 |
...
| 参数项 | 描述 |
| --- | --- |
| HiTraceId *id | 需要设置分支ID的 HiTraceId 。 |
...
| 参数项 | 描述 |
| --- | --- |
| const HiTraceId *id | 需要获取父分支ID的 HiTraceId 。 |
...
| 参数项 | 描述 |
| --- | --- |
| HiTraceId *id | 需要设置父分支ID的 HiTraceId 。 |
...
| 参数项 | 描述 |
| --- | --- |
| const HiTraceId * id | 需要转换的 HiTraceId 。 |

...
| 类型 | 说明 |
| --- | --- |
| int | 成功返回 OH_IPC_ErrorCode#OH_IPC_SUCCESS ； 参数错误返回 OH_IPC_ErrorCode#OH_IPC_CHECK_PARAM_ERROR ； 其它情况返回 OH_IPC_ErrorCode#OH_IPC_INNER_ERROR 。 |
...
| 类型 | 说明 |
| --- | --- |
| int | 成功返回 OH_IPC_ErrorCode#OH_IPC_SUCCESS ； 参数错误返回 OH_IPC_ErrorCode#OH_IPC_CHECK_PARAM_ERROR ； 内存分配失败返回 OH_IPC_ErrorCode#OH_IPC_MEM_ALLOCATOR_ERROR ； 其它情况返回 OH_IPC_ErrorCode#OH_IPC_INNER_ERROR 。 |

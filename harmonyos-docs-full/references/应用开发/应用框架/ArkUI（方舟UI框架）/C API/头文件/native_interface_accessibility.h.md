...
| 类型 | 说明 |
| --- | --- |
| int32_t | 成功返回 ARKUI_ACCESSIBILITY_NATIVE_RESULT_SUCCESSFUL 。 参数错误返回 ARKUI_ACCESSIBILITY_RESULT_BAD_PARAMETER 。 |
...
| --- | --- |
| ArkUI_AccessibilityElementInfo * elementInfo | 表示指向ArkUI_AccessibilityElementInfo的指针。 |
| const char* hitTestBehavior | 表示hitTest模式，取值范围参考 HitTestMode 。 |

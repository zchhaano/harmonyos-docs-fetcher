...
| OFFSET_WITH_CARET 14+ | 2 | 上抬模式，输入框光标位置发生变化时候也会触发避让。 元服务API： 从API version 14开始，该接口支持在元服务中使用。 |
| RESIZE_WITH_CARET 14+ | 3 | 压缩模式，输入框光标位置发生变化时候也会触发避让。 元服务API： 从API version 14开始，该接口支持在元服务中使用。 |
| NONE 14+ | 4 | 不避让键盘。 元服务API： 从API version 14开始，该接口支持在元服务中使用。 |

## SwiperDynamicSyncSceneType 12+
...
## MarqueeDynamicSyncSceneType 14+

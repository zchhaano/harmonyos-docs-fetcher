...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| uri | string | 是 | 编辑后图片的 uri ，格式为file://<bundleName>/<sandboxPath>。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<AbilityResult> | Promise对象，返回AbilityResult对象，编辑过的图片uri存在want.uri中， uri 格式为file://<bundleName>/<sandboxPath>。 |

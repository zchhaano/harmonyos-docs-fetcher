...
## dlpPermission.startDLPManagerForResult 11+
...
## dlpPermission.setSandboxAppConfig 11+
...
## dlpPermission.cleanSandboxAppConfig 11+
...
## dlpPermission.getSandboxAppConfig 11+
...
## dlpPermission.isDLPFeatureProvided 12+
...
## dlpPermission.setEnterprisePolicy 21+
...
| flags | number | 否 | 否 | 表示DLP文件的详细操作权限，是不同 ActionFlagType 的组合。 |
...
## dlpPermission.generateDlpFileForEnterprise 21+
...
## dlpPermission.decryptDlpFile 21+
...
## dlpPermission.queryDlpPolicy 21+

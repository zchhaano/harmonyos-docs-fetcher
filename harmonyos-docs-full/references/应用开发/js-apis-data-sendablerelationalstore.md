...
## sendableRelationalStore.fromSendableValues 20+
...
## sendableRelationalStore.toSendableValues 20+
...
| status | number | 否 | 是 | 资产的状态，取值与 relationalStore.AssetStatus 枚举值保持一致，默认值为relationalStore.AssetStatus.ASSET_NORMAL。 |

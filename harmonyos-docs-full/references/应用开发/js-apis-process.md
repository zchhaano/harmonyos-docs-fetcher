...
从API version 7开始支持，从API version 9开始废弃，建议使用[kill 9+](/consumer/cn/doc/harmonyos-references/js-apis-process#kill9)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[exit 9+](/consumer/cn/doc/harmonyos-references/js-apis-process#exit9)替代。
...
从API version 8开始支持，从API version 9开始废弃，建议使用[getUidForName 9+](/consumer/cn/doc/harmonyos-references/js-apis-process#getuidforname9)替代。
...
从API version 8开始支持，从API version 9开始废弃，建议使用[getThreadPriority 9+](/consumer/cn/doc/harmonyos-references/js-apis-process#getthreadpriority9)替代。
...
从API version 8开始支持，从API version 9开始废弃，建议使用[isAppUid 9+](/consumer/cn/doc/harmonyos-references/js-apis-process#isappuid9)替代。
...
从API version 8开始支持，从API version 9开始废弃，建议使用[getSystemConfig 9+](/consumer/cn/doc/harmonyos-references/js-apis-process#getsystemconfig9)替代。
...
从API version 8开始支持，从API version 9开始废弃，建议使用[getEnvironmentVar 9+](/consumer/cn/doc/harmonyos-references/js-apis-process#getenvironmentvar9)替代。

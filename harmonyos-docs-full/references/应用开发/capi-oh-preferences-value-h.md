...
| int OH_PreferencesValue_GetInt(const OH_PreferencesValue *object, int *value) | 从PreferencesValue对象 OH_PreferencesValue 中获取一个整型值。 |
| int OH_PreferencesValue_GetBool(const OH_PreferencesValue *object, bool *value) | 从PreferencesValue对象 OH_PreferencesValue 中获取一个布尔值。 |
| int OH_PreferencesValue_GetString(const OH_PreferencesValue *object, char **value, uint32_t *valueLen) | 从PreferencesValue对象 OH_PreferencesValue 中获取字符串。 |
...
| 参数项 | 描述 |
| --- | --- |
| const OH_PreferencesPair *pairs | 目标KV数据 OH_PreferencesPair 的指针。 |
| uint32_t index | 目标KV数据 OH_PreferencesPair 的索引值。 |
...
| 参数项 | 描述 |
| --- | --- |
| const OH_PreferencesValue *object | 对象 OH_PreferencesValue 的指针。 |

...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| pid | number | 是 | 需要被压制子进程的进程号， OH_Ability_StartNativeChildProcess 接口创建子进程后的pid参数，即为子进程进程号。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| pid | number | 是 | 子进程的进程号， OH_Ability_StartNativeChildProcess 接口创建子进程后的pid参数，即为子进程进程号。 |
...
## backgroundProcessManager.setPowerSaveMode 20+
...
## backgroundProcessManager.isPowerSaveMode 20+

...
| font-weight | number \| string | normal | 否 | 设置跑马灯中文字的字体的粗细，见 text组件font-weight的样式属性 。 |
| font-family | string | sans-serif | 否 | 设置跑马灯中文字的字体列表，用逗号分隔，每个字体用字体名或者字体族名设置。列表中第一个系统中存在的或者通过 自定义字体 指定的字体，会被选中作为文本的字体。 |
...
![image](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20260224170910.10937750645924432097945743670802:50001231000000:2800:70F5EF98D2DDF515245E63909D516AA9D5D2D64489BCEDC8FD966A22FCB4B748.gif)
...
从API version 7开始，推荐使用[@ohos.window](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-window)。
...
| 名称 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| appID 6+ | string | 是 | 表示应用的包名，用于标识应用的唯一性。 系统能力： SystemCapability.ArkUI.ArkUI.Full |

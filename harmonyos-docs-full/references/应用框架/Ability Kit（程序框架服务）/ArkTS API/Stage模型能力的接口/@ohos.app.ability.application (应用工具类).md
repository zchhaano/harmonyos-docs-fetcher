...
| TYPE_CREATE_ABILITY_STAGE | 2 | 进程最终预加载到 AbilityStage 创建完成阶段。 |
| TYPE_CREATE_WINDOW_STAGE | 3 | 进程最终预加载到 WindowStage 创建完成阶段。 |

## application.createModuleContext 12+
...
## application.getApplicationContext 14+
...
## application.createPluginModuleContext 19+
...
## application.promoteCurrentToCandidateMasterProcess 20+
...
## application.demoteCurrentFromCandidateMasterProcess 20+
...
## application.exitMasterProcessRole 21+
...
## application.getAppPreloadType 22+

...
```
let a : number = 1 ; let b : string = '2' ; a = b;
```
...
```
let a : number = 1 ; let b : number = 2 ; a = b;
```
...
```
// har1's src/main/ets/FileJs.js export let fileJs = 1 ;
```
...
```
// har1's src/main/ets/FileJs.d.ts export declare let fileJs : number ;
```

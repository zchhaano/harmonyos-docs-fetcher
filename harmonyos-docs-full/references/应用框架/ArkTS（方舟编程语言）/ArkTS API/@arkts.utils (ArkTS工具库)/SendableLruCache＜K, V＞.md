...
SendableLruCache在缓存空间不足时，会用新数据替换近期最少使用的数据。此设计基于资源访问的考虑：近期访问的数据可能在不久的将来再次访问，因此最少访问的数据价值最小，应优先移出缓存。SendableLruCache支持Sendable特性，可保存Sendable对象，确保跨线程安全访问。
  ...
  ![image](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f3/v3/MBD-BE_FTLuS0zFGLy-FCg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260420T194256Z&HW-CC-Expire=86400&HW-CC-Sign=DDC6D205A3DE5EC35FF9E30C8ED44984A40049B13732FD7AB97FFFE6CB8D2461)   
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| length 18+ | number | 是 | 否 | 当前缓冲区中值的总数。 |

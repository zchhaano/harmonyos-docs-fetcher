# Interfaces (其他)
   ...
   ![image](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d1/v3/9W6nNfjcRTWAppfVtXknpw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260420T194206Z&HW-CC-Expire=86400&HW-CC-Sign=91FB3FBC485D0441069762824642B504EF53C18914D1A7FD30A0312E742E29D4)   
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| fd | number | 否 | 否 | 资源句柄，通过 resourceManager.getRawFd 获取，也可以通过 fileIo.open 获取。 |
...
| description 23+ | string | 否 | 是 | 媒体资源的描述信息。当前版本为只读参数。不支持AVRecorder设置该属性。 |
...
#### [h2]AVMetadata.tracks支持的MediaDescriptionKey 8+ 说明
...
| privacyMaskMode 23+ | number | 否 | 是 | 设置屏幕录制时对隐私窗口的屏蔽模式。 - 0：表示存在隐私窗口时，采用全屏屏蔽模式，默认是0。 - 1：表示存在隐私窗口时，采用隐私窗口屏蔽模式。 - 设置为其他值时返回错误。 模型约束： 此接口仅可在Stage模型下使用。 |
...
#### AudioRecorderConfig (deprecated)
  ...
  ![image](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e6/v3/S-AmyrX-QBOMb_77CRMPsg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260420T194206Z&HW-CC-Expire=86400&HW-CC-Sign=F800EBF0441569F6155A4B2F3E5B703C1A6C29E0DC6D5B499BB8F38DC596C3A6)   

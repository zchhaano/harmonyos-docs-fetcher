...
在使用AudioRenderer的接口之前，需先通过[createAudioRenderer](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-audio-f#audiocreateaudiorenderer8)获取AudioRenderer实例。
  ...
  ![image](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/87/v3/t7CTHva7Q4yBlBGluC7ppQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260420T194130Z&HW-CC-Expire=86400&HW-CC-Sign=F46C16F49BEBCF2461B48343064695FE6FF8E5E12C68BF429CF8C211A63A5C00)   
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| state 8+ | AudioState | 是 | 否 | 音频渲染器的状态。 |
...
获取当前音频路由的预估时延。
  ...
  ![image](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c8/v3/wdOYewKYTIC8s6W2r6j8ZQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260420T194130Z&HW-CC-Expire=86400&HW-CC-Sign=C5A575308A9A86161E60054A646908D9113885CF91451180570135103CCA57AB)   
...
#### getCurrentOutputDevicesSync 10+
...
#### setSilentModeAndMixWithOthers 12+
...
#### getSilentModeAndMixWithOthers 12+
...
设置默认发声设备。使用Promise异步回调。
  ...
  ![image](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6b/v3/OWVmGIKuSbqtQ74uNNn9UQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260420T194130Z&HW-CC-Expire=86400&HW-CC-Sign=59E4FE4F8DAE714CF7256ED58B3ADBEBFF90D74C4149E15D456B0ED19EA02F2C)   
...
| callback | AudioRendererWriteDataCallback | 是 | 回调函数，入参代表应用接收待写入的数据缓冲区。 API version 11 不支持返回回调结果，从 API version 12 开始支持返回回调结果 AudioDataCallbackResult 。 |
...
| callback | AudioRendererWriteDataCallback | 否 | 回调函数，入参代表应用接收待写入的数据缓冲区。 API version 11 不支持返回回调结果，从 API version 12 开始支持返回回调结果 AudioDataCallbackResult 。 |
...
写入缓冲区。使用callback异步回调。
  ...
  ![image](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9a/v3/C2icPFz7QTSK4uxZ2tJRqg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260420T194130Z&HW-CC-Expire=86400&HW-CC-Sign=C0A0E83229A13489826D33EF7610037B38D834EF432D85608490A1F32785AFCE)   
...
写入缓冲区。使用Promise异步回调。
  ...
  ![image](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/81/v3/LrnQwIoKQACM3VT_dH2w8Q/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260420T194130Z&HW-CC-Expire=86400&HW-CC-Sign=9C340F89399915C8EC644F7D82DD2F75E3D974871938CBCCAF1A8AC802F74E04)   
...
设置音频渲染速率。使用callback异步回调。
  ...
  ![image](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/35/v3/9A_Mc1JIQNWVHju3-sJfMA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260420T194130Z&HW-CC-Expire=86400&HW-CC-Sign=E2B8333B39E95A59007D2DE3AEE30E761EA6E875B028768C5594C410BC76A4E2)   
...
设置音频渲染速率。使用Promise异步回调。
  ...
  ![image](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b/v3/Rl8QGi1NSvyBtPN1uIIECA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260420T194130Z&HW-CC-Expire=86400&HW-CC-Sign=4A7440747F2A3B7E308BDAB75623542E9FFA0D251EE8E7D0ED916C555F15B17F)   
...
获取音频渲染速率。使用callback异步回调。
  ...
  ![image](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/77/v3/pCW0to2ZTjSxkbZJLRvT_A/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260420T194130Z&HW-CC-Expire=86400&HW-CC-Sign=BFEA1E8C1FB7F8A60ECE0B9C7733BD487A5295117B71584645AB6CE5478ADD85)   
...
获取音频渲染速率。使用Promise异步回调。
  ...
  ![image](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/dd/v3/7tB5jjrgS5-c4trxgRzh6w/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260420T194130Z&HW-CC-Expire=86400&HW-CC-Sign=61B1CD00F19688FA7E8197B99BB75AA3405AD1A9EEEC2936385C03D6F80095C6)   
...
获取音频渲染速率。同步返回结果。
  ...
  ![image](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ce/v3/H7KUa5Z0QSKOyv8dwGHk8A/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260420T194130Z&HW-CC-Expire=86400&HW-CC-Sign=AA61025C0B6D79318A446D0AB30C0AAA7DD77F9BB1950A75B8E4D7CB4BF18AB7)   
...
设置播放响度。使用Promise异步回调。
  ...
  ![image](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b5/v3/E-gygUMGTkOnUteCxxmD8A/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260420T194130Z&HW-CC-Expire=86400&HW-CC-Sign=8E5B874E2BF81CD734FC5BDFF88CAA698A0F8A123C362589E9F72D811D9D3D10)   

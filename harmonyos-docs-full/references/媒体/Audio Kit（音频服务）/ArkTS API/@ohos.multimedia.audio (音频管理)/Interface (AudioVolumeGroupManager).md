...
| 类型 | 说明 |
| --- | --- |
| number | 返回指定流的音量。指定流的音量等级范围可通过 getMinVolume 和 getMaxVolume 获取。 |
...
## getMaxAmplitudeForInputDevice 12+
...
## getMaxAmplitudeForOutputDevice 12+

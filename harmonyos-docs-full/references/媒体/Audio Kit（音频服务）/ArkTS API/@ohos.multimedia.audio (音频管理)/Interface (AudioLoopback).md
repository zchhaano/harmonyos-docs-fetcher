...
输入\输出设备由系统自动选择。如果当前输入\输出不支持低时延，则音频返听无法启用。在运行过程中，如果音频焦点被另一个音频流抢占，输入\输出设备切换到不支持低时延的设备，系统会自动禁用音频返听。
  ...
  ![image](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f5/v3/taNHybU0TVS8TJg51nBX5A/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260420T194130Z&HW-CC-Expire=86400&HW-CC-Sign=A6B5E8DC1814B4B26D362FC4C3076627C9300D94953738AB666B81381A0ECBBF)   

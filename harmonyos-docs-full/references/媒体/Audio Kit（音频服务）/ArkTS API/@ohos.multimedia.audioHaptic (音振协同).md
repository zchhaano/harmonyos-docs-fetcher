...
音振协同，表示在播放声音时，可同步发起振动。可用于来电通知、消息提醒等场景。
  ...
  ![image](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c1/v3/ACaSjlfYTpW7b6pomZqCwA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260420T194132Z&HW-CC-Expire=86400&HW-CC-Sign=CBD81BB85A62A4BD93BD2CDD271940D8EF354075D4F393AA23A9488DBA01EC3A)   
...
| AUDIO_LATENCY_MODE_FAST | 1 | 低时延模式。该模式适用于比较短的音频文件，音频文件过长时可能被截断，该特性与 SoundPool 一致。 |
...
#### AudioHapticFileDescriptor 20+

 

描述音振文件描述符。

  ![image](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c2/v3/TlDKTFjGT8OwTvm0SKQglA/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260420T194132Z&HW-CC-Expire=86400&HW-CC-Sign=D0DEF9E140D80BDE50056F0126497FF53CB6BD48003EA795A1F1B688FE997E83)   
...
通过Uri注册音频和振动资源。使用Promise异步回调。
  ...
  ![image](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4d/v3/bIRyxAJ7TneAVpXa18mABw/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260420T194132Z&HW-CC-Expire=86400&HW-CC-Sign=52E259490ABA4319AF8516EB68CB80A2CBECCCD93B1F518E1D7E3A424326CAEB)   
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| audioUri | string | 是 | 音频资源的Uri。 - 对普通时延模式，音频资源格式和路径格式的支持可参考 AVPlayer 。 - 对低时延模式，音频资源格式支持可参考 SoundPool ，路径格式需满足 fileIo.open 的要求。 - 对两种时延模式，均建议传入文件的绝对路径。 |
| hapticUri | string | 是 | 振动资源的Uri。 振动资源格式支持可参考 HapticFileDescriptor ，路径格式需满足 fileIo.open 的要求。 建议传入文件的绝对路径。 |
...
通过文件描述符注册音频和振动资源。使用Promise异步回调。
  ...
  ![image](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/45/v3/qJaL1UuGToGbA8pgGvKjxQ/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260420T194132Z&HW-CC-Expire=86400&HW-CC-Sign=C235B4DAE05DC8DDF765AAAE00388E480B783A917BE0554B4639B8CB1945D660)   
...
取消注册音频和振动资源。使用Promise异步回调。
  ...
  ![image](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/28/v3/qsXO-xAPSwqK9lJI0zgXMw/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260420T194132Z&HW-CC-Expire=86400&HW-CC-Sign=1F3CB78FBDDAB9DE5C8BD251F97E099320EDC3134CC3CC077EF633740873244A)   
...
设置音振播放器的音量。使用Promise异步回调。
  ...
  ![image](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fc/v3/AF-SkvCgSouWOJNeYsLZGQ/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260420T194132Z&HW-CC-Expire=86400&HW-CC-Sign=EB7208B7FC8A85658B857F60717F9C6F4EFDDC2CD68BBD28D753E3D27B93661F)   
...
设置音振播放器循环播放。使用Promise异步回调。
  ...
  ![image](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5/v3/rCWnttYNTaaLjTe8shlZWg/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260420T194132Z&HW-CC-Expire=86400&HW-CC-Sign=09181AB1D6A62379BF1216E7284D680D27F590E805CB36B3D1370A1116034426)   

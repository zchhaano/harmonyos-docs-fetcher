...
```
POST / api / v2 / contract / unsign HTTP / 1.1 Content - Type : application / json ; charset = UTF - 8 PayMercAuth : { "callerId" : "10132120***" , "traceId" : "202305151442062977847" , "time" : 1684132926969 , "authId" : "120291744647139***" , "headerSign" : "BpOBa8o+gJnKG+vHVI7u********************mVuKDV8iPqNJ+Y8b4XDpSi3FHgjozsWH+uLoTSIg=" , "bodySign" : "lHjrX3dv44zyfu+PO1G+oa9tJi2********************EatA8QTjLPsSPKfM=" } Accept : application / json { "mercContractCode" : "2024020316555432***" , "mercNo" : "10132120***" }
```
...
```
HTTP / 1.1 200 OK Content - Type : application / json ; charset = UTF - 8 { "mercContractCode" : "2024020316555432***" , "resultCode" : "000000" , "sign" : "MEUCIQCFNGKlqpBiH********************6h433eRZI9A07c9NiF91jeGRXNUtc0=" , "planId" : "1***" , "resultDesc" : "success" , "mercNo" : "10132120***" }
```

# 一键登录获取华为账号绑定号码和UnionID/OpenID
   ...
   ![image](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ba/v3/B55yW-P8Td6hbPqeOrsBBQ/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260420T194224Z&HW-CC-Expire=86400&HW-CC-Sign=D30A1E0B6CB2B9970E565267570D1D3456F372832AA988972F1A1F59911D7F86)   
...
| phoneNumber | 是 | String | 华为账号绑定号码（含国家码），使用该手机号完成一键登录的功能，详见 华为账号一键登录（获取手机号和UnionID/OpenID） 。 |
...
| 60180007 | code未授权华为账号一键登录权限。 | code未授权华为账号一键登录权限，可能原因如下： - 应用使用华为账号一键登录功能之前，需要完成华为账号一键登录权限申请，详见 申请账号权限 。 - code不是通过调用华为账号的一键登录组件获取到的，请参考 客户端开发 的展示一键登录页面并获取Authorization Code，获取华为账号一键登录场景所需的code参数。 |

...
```
post /api/rms/v1/deviceVerify/checkDeviceToken HTTP/1.1 Host: xxx Authorization: Bearer eyJr*****OiIx---****.eyJh*****iJodHR--***.QRod*****4Gp---**** bundleName: com.huawei.xxx Content-Type: application/json;charset=utf-8 {"data":{ "deviceToken":"xxx", "transactionId":"xxx", "timestamp":1704038400}}
```

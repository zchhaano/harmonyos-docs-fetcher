...
蜂窝数据提供了移动数据管理能力，包括获取默认移动数据的SIM卡、获取蜂窝数据业务的上下行数据流状态、蜂窝数据业务链路连接状态，以及检查蜂窝数据业务和漫游是否启用等。
  ...
  ![image](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cf/v3/_M3ZeNFsTy24ZQC7AiT7ZA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260420T194352Z&HW-CC-Expire=86400&HW-CC-Sign=3B00C8B00C62D9AADBC40FBB4B27A921F2D7F31EB91DB5229FB75440256A922B)   
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| apnId | number | 是 | 要设置的apnId，可以通过 queryApnIds 查询。 |

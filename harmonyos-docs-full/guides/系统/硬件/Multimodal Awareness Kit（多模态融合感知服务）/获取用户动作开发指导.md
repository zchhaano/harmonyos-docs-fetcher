...
详细的接口介绍请参考[Motion接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-awareness-motion)。
...
```
"requestPermissions" :[ { "name" : "ohos.permission.ACTIVITY_MOTION" }, { "name" : "ohos.permission.DETECT_GESTURE" } ]
```
...
```
"requestPermissions" :[ { "name" : "ohos.permission.DETECT_GESTURE" } ]
```

...
![image](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20260224170103.18518214375834164336313412639588:50001231000000:2800:6D7AA5182A03270FE41B16F8BD0C3E06419D3D3BDBB59B7C20A610829D9B45D5.png)
...
```
# include <scsi_peripheral/scsi_peripheral_api.h> # include <scsi_peripheral/scsi_peripheral_types.h>
```
...
```
// 初始化SCSI Peripheral DDK int32_t ret = OH_ScsiPeripheral_Init ();
```
...
```
int32_t ret = OH_ScsiPeripheral_ParseBasicSenseInfo (response.senseData, SCSIPERIPHERAL_MAX_SENSE_DATA_LEN, &senseInfo);
```

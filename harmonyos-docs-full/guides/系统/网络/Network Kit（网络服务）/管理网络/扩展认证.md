...
```
try { eap. logOffEthEap (netId); hilog. error ( 0x0000 , 'testTag' , 'logOffEthEap success' ); // ··· } catch (err) { // ··· hilog. error ( 0x0000 , 'testTag' , 'errCode: ' + err. code + ', errMessage: ' + err. message ); }
```

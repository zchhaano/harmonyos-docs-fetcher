...
```
int32_t ReportQoe () { NetworkBoost _ServiceType serviceType = NB_SERVICE_SHORT_VIDEO ; NetworkBoost _QoeType qoeType = NB_QOE_BAD_SERVER_ERROR ; int32_t ret = HMS_NetworkBoost_ReportQoe (serviceType, qoeType); printf ( "传输体验反馈结果: %d\n" , ret); return ret; }
```
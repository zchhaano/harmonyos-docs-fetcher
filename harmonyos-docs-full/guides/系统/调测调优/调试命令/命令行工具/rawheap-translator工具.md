...
```
echo 'export PATH=$PATH:/path/to/your/rawheap_translator' >> ~/.bash_profile source ~/.bash_profile
```
...
```
echo 'export PATH=$PATH:/path/to/your/rawheap_translator' >> ~/.zshrc source ~/.zshrc
```

...
| void OH_LOG_SetLogLevel(LogLevel level, PreferStrategy prefer) | 设置当前应用程序进程的最低日志级别。可以配置不同的偏好策略。 说明 ：从API version 21开始，支持该接口。 |
   ...
   ![image](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/13/v3/v2Lc3dkbSK6yZVdASWiXPA/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260420T193841Z&HW-CC-Expire=86400&HW-CC-Sign=73DA1EC5FFE82A0D115F888837C6ECBE6D906C98E56A3147BB8771E99CD4DEA6)   
...
- args：可以为0个或多个参数，是格式字符串中参数类型对应的参数列表。参数的数量、类型必须与格式字符串中的标识一一对应。
  ...
  ![image](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d5/v3/UNyvI4zHQ6Oae5Gq8nQZkA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260420T193841Z&HW-CC-Expire=86400&HW-CC-Sign=64A03641A9DDC7199F7D543158C584874614F06DA18388D0B930776276D649A2)   
...
#### [h2]日志回调接口使用示例
  ...
  ![image](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1d/v3/CzLyY5EIScWT8zE7NOMqnA/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260420T193841Z&HW-CC-Expire=86400&HW-CC-Sign=B2B7BA390C23AB475444B30BE4748CB1749E790DC78D19099B627CE85C1B289B)   

...
本文介绍如何使用HiAppEvent提供的C/C++接口订阅应用崩溃事件。详细使用说明请参考[hiappevent.h](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-hiappevent-h)。
  ...
  ![image](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/85/v3/vkV8FFzURcWZAkhM_QYAKA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260420T193837Z&HW-CC-Expire=86400&HW-CC-Sign=9AFE123F1F5062C4C8C2B435451F03CFAC19538C0749401300604795C69C1E7A)   
...
9. 点击运行按钮，启动应用工程。在应用界面中点击“JsError”按钮，触发崩溃事件。系统生成相应的崩溃日志并进行回调。
  ...
  ![image](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ba/v3/6yXToLsLRlW-sQDX-BiXbA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260420T193837Z&HW-CC-Expire=86400&HW-CC-Sign=5F8DE1BDBC5C127BBA485A6DBBA7B48345C4461E3A72E75E641999CDF7DBB5FE)   

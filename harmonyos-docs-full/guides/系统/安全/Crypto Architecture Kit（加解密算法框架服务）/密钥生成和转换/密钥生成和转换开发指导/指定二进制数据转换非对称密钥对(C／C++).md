...
以RSA、ECC、SM2为例，根据指定的非对称密钥二进制数据，生成非对称密钥对（OH_CryptoKeyPair），即将外部或存储的二进制数据转换为算法库的密钥对象，该对象可用于后续的加解密等操作。
  ...
  ![image](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/52/v3/WoQuP50JRJaryKWtuYbu9A/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260420T193803Z&HW-CC-Expire=86400&HW-CC-Sign=6DE5C1BB84DCF5399B96A629261016B85B3D6FB63B546B5031277C43D7CC25F1)   

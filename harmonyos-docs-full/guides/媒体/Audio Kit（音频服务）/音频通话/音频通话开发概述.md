...
在开发音频通话相关功能时，开发者可以根据实际情况，检查当前的[音频场景模式](/consumer/cn/doc/harmonyos-guides/audio-call-overview#音频场景模式)和[铃声模式](/consumer/cn/doc/harmonyos-guides/audio-call-overview#铃声模式)，以使用相应的音频处理策略。

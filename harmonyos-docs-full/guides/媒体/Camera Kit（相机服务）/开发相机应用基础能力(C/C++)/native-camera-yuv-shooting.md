...
6. 注册单段式(PhotoAvailable)或分段式(PhotoAssetAvailable)拍照回调，若应用希望快速得到回图，推荐使用[分段式拍照(PhotoAssetAvailable)](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/native-camera-deferred-capture)回调。
  ...
  ![image](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/93/v3/15PbVcONRSSzaJdIlQmR0A/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260420T191153Z&HW-CC-Expire=86400&HW-CC-Sign=03314E646AD7C117F6DBB3897575E678C7A207162C35FF1C17EBA68A1CCEB743)   

...
使用DisplaySoloist接口配置帧率和注册每帧回调函数。如果使用OH_DisplaySoloist_Create创建DisplaySoloist实例时传入的参数useExclusiveThread为true，则OH_DisplaySoloist_FrameCallback以独占线程方式执行，否则OH_DisplaySoloist_FrameCallback以共享线程方式执行。
  ...
  ![image](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d/v3/cpG4gY2iRqCMdiziwYlPPw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260420T193629Z&HW-CC-Expire=86400&HW-CC-Sign=B2ADC9F61AB948205F0205002B4DDE03CFBCB1F0451A9C8AA432DA2E5B1EFB80)   

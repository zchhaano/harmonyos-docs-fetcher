...
```
// code-linter.json5 { "rules" : { "@typescript-eslint/no-confusing-void-expression" : "error" } }
```
...
```
export function func ( ): void { console . info ( 'no return' ); }
```
...
```
export function func ( ): void { return console . info ( 'no return' ); } console . info ( func ());
```

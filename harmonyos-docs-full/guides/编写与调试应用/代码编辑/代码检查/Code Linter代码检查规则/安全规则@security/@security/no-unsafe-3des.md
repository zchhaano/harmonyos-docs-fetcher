...
```
// code-linter.json5 { "rules" : { "@security/no-unsafe-3des" : "error" } }
```
...
```
import cryptoFramework from '@ohos.security.cryptoFramework' ; cryptoFramework. createCipher ( '3DES|CBC' );
```
...
```
import cryptoFramework from '@ohos.security.cryptoFramework' ; cryptoFramework. createCipher ( '3DES|ECB' );
```

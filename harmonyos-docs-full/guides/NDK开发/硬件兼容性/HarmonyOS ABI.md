...
采用IEEE754作为浮点编码格式，针对long double的格式定义，将在[支持架构ABI](/consumer/cn/doc/harmonyos-guides/ohos-abi#支持架构abi)具体说明。
...
```
{ "apiType" : "stageMode" , "buildOption" : { "externalNativeOptions" : { "path" : "./src/main/cpp/CMakeLists.txt" , "arguments" : "" , "abiFilters" : [ "arm64-v8a" ] } } }
```

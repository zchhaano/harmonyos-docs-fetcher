...
| 弹出框层级管理 | 从API version 18开始，可以通过设置 levelOrder 参数来管理弹出框的显示顺序。 |
| 弹出框控制器 | 从API version 18开始，可设置controller参数以绑定 DialogController 控制器，通过控制器可以对弹出框进行操作。 |
| 弹出框焦点策略 | 从API version 19开始，可以通过设置 focusable 参数来管理弹出框是否获取焦点。 |

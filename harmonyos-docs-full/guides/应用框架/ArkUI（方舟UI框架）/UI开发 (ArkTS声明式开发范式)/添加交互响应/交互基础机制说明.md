...
![image](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20260224165820.45501038266029111140979977011917:50001231000000:2800:A673D599EEF16D33C454AF272C616ECA487818F217F1A5C8F288F394427EA6CA.png)
...
![image](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20260224165820.40875799949256743827799589864260:50001231000000:2800:5F74F9C261649F22227CF6F27017E244C3854519AE5D387FAB7745E9833193B6.png)
...
![image](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20260224165820.09195199783888413918227216299000:50001231000000:2800:918F27DC7EB67BB1C7C0A491C612F4EE754D6AA40B1E8D8DDBE164CA5F2FB09E.png)
...
```
@Entry @Component struct FocusOnclickExample { @State text : string = '' ; @State number : number = 0 ; build ( ) { Column () { Text ( this . text ) . margin ({ bottom : 20 }) // 请将$r('app.string.button')替换为实际资源文件，在本示例中该资源文件的value值为"按钮" Button ($r( 'app.string.button' )) . responseRegion ([ { x : 0 , y : 0 , width : '30%' , height : '100%' }, // 第一个热区为按钮的左侧1/3区域 { x : '70%' , y : 0 , width : '30%' , height : '100%' }, // 第二个热区为按钮的右侧1/3区域 ]) . onClick ( () => { this . number ++; this . text = 'button' + this . number + 'clicked' ; }) . width ( 200 ) }. width ( '100%' ). justifyContent ( FlexAlign . Center ) } }
```
...
![image](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20260224165820.59543447332751675451927162919447:50001231000000:2800:1035F0CE2EC899AC39C28EA0E47EACD24A8920E62805C222A64ECAE542966B30.png)
2. 触摸测试控制
...
![image](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20260224165820.99269224760774939714906351752542:50001231000000:2800:9133B92E4F0C493F831D315B3B454FD9C5257B9D78BCC3A00083FBA8D5C42AE6.png)
  - HitTestMode.None：自身不接收事件，但不会阻塞兄弟组件或子组件继续做触摸测试。

![image](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20260224165820.09177754326028526198548553981676:50001231000000:2800:B35E8441D9DE12FC8BA515742339B35F6B99C4BCC8309993F7545CC0031D0837.png)
  - HitTestMode.Block：阻塞子组件的触摸测试，如果自身触摸测试命中，会阻塞兄弟组件及父组件的触摸测试。

![image](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20260224165820.17462925853778759238237778978304:50001231000000:2800:94D08675199843ADC80871898B6A28E56CE6304217B1598C170A4D72AF48F554.png)
  - HitTestMode.Transparent：自身进行触摸测试，同时不阻塞兄弟组件及父组件。

![image](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20260224165820.08480434738417801929294886049209:50001231000000:2800:7BCD6C22ED1DAB11A1F88FD232B57406649AD6340052819EFDAC02CF9C46BEC9.png)
  - HitTestMode.BLOCK_HIERARCHY（从API version 20开始支持）: 自身和子节点响应触摸测试，阻止所有优先级较低的兄弟节点和父节点参与触摸测试。

![image](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20260224165820.37749761348587730901942783049737:50001231000000:2800:DFBC58E0C987B105552A87E117D5D3C5FECFB8B32B3B571DFADA2322FE1BF5E1.png)
  - HitTestMode.BLOCK_DESCENDANTS（从API version 20开始支持）: 自身不响应触摸测试，并且所有的后代（孩子，孙子等）也不响应触摸测试，不会影响祖先节点的触摸测试。

![image](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20260224165820.68258363404882853052167475776045:50001231000000:2800:364FD21AC26DA5869A92A2B39964CC3C5DF244CD0CA712BCA5645261B6AAC0F6.png)
3. 自定义事件拦截
...
![image](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20260224165820.80714614232727471963366751857330:50001231000000:2800:120B1DF7B6CDE239083622CE48C7A2AB7EC13A820AE5A19B94648717D4352BF4.png)

...
```
Column () { Column (). id ( 'ComponentB' ). onTouch ( () => {}) Column (). id ( 'ComponentC' ). onTouch ( () => {}) }. id ( 'ComponentA' ). onTouch ( () => {})
```
...
```
Stack () { Column (). id ( 'ComponentB' ). onTouch ( () => {}) Column (). id ( 'ComponentC' ). onTouch ( () => {}) }. id ( 'Stack A' ). onTouch ( () => {})
```
...
```
Column () { Column (). id ( 'ComponentB' ). gesture ( TapGesture ({ count : 1 })) }. id ( 'ComponentA' ). gesture ( TapGesture ({ count : 1 }))
```
...
```
Column () . id ( 'ComponentA' ) . gesture ( GestureGroup ( GestureMode . Exclusive , TapGesture ({ count : 1 }), PanGesture ({ distance : 5 }) ) )
```
...
```
Column () { Column () . id ( 'ComponentB' ) . onTouch ( () => {}) . gesture ( TapGesture ({ count : 1 })) . responseRegion ([rect1, rect2, rect3]) } . id ( 'ComponentA' ) . onTouch ( () => {}) . gesture ( TapGesture ({ count : 1 })) . responseRegion ([rect4])
```
...
```
Column () { Column () . id ( 'ComponentB' ) . onTouch ( () => {}) . gesture ( TapGesture ({ count : 1 })) Column () { Column () . id ( 'ComponentD' ) . onTouch ( () => {}) . gesture ( TapGesture ({ count : 1 })) } . id ( 'ComponentC' ) . onTouch ( () => {}) . gesture ( TapGesture ({ count : 1 })) . hitTestBehavior ( HitTestMode . Block ) } . id ( 'ComponentA' ) . onTouch ( () => {}) . gesture ( TapGesture ({ count : 1 }))
```
...
```
Stack () { Column () . id ( 'ComponentB' ) . onTouch ( () => {}) . gesture ( TapGesture ({ count : 1 })) Column () . id ( 'ComponentC' ) . onTouch ( () => {}) . gesture ( TapGesture ({ count : 1 })) . hitTestBehavior ( HitTestMode . Transparent ) } . id ( 'Stack A' ) . onTouch ( () => {}) . gesture ( TapGesture ({ count : 1 }))
```
...
```
Column () { Column () . id ( 'ComponentB' ) . onTouch ( () => {}) . gesture ( TapGesture ({ count : 1 })) } . id ( 'ComponentA' ) . onTouch ( () => {}) . gesture ( TapGesture ({ count : 1 })) . hitTestBehavior ( HitTestMode . None )
```
...
```
Stack () { Column () . id ( 'ComponentB' ) . onTouch ( () => {}) . gesture ( TapGesture ({ count : 1 })) Column () { Column () . id ( 'ComponentD' ) . onTouch ( () => {}) . gesture ( TapGesture ({ count : 1 })) } . id ( 'ComponentC' ) . onTouch ( () => {}) . gesture ( TapGesture ({ count : 1 })) . hitTestBehavior ( HitTestMode . BLOCK_HIERARCHY ) } . id ( 'Stack A' ) . onTouch ( () => {}) . gesture ( TapGesture ({ count : 1 }))
```
...
```
Stack () { Column () . id ( 'ComponentB' ) . onTouch ( () => {}) . gesture ( TapGesture ({ count : 1 })) Column () { Column () . id ( 'ComponentD' ) . onTouch ( () => {}) . gesture ( TapGesture ({ count : 1 })) } . id ( 'ComponentC' ) . onTouch ( () => {}) . gesture ( TapGesture ({ count : 1 })) . hitTestBehavior ( HitTestMode . BLOCK_DESCENDANTS ) } . id ( 'Stack A' ) . onTouch ( () => {}) . gesture ( TapGesture ({ count : 1 }))
```
...
```
Column () { Column () . id ( 'ComponentB' ) . gesture ( TapGesture ({ count : 1 })) } . id ( 'ComponentA' ) . priorityGesture ( TapGesture ({ count : 1 }))
```
...
```
Column () { Column () . id ( 'ComponentB' ) . gesture ( TapGesture ({ count : 1 })) } . id ( 'ComponentA' ) . parallelGesture ( TapGesture ({ count : 1 }))
```
...
```
@Builder function builderOverlay ( params: Params ) { Component1 (). hitTestBehavior ( HitTestMode . Transparent ) } // ··· aboutToAppear (): void { // ··· let componentContent = new ComponentContent ( this . context , wrapBuilder<[ Params ]>(builderOverlay), new Params (uiContext, { x : 0 , y : 100 }) ); this . overlayManager . addComponentContent (componentContent, 0 ); }
```

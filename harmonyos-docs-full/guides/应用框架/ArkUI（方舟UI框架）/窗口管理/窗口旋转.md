...
不同旋转策略之间的差异及设备相关差异性可见[旋转策略及设备差异性](/consumer/cn/doc/harmonyos-guides/window-rotation#旋转策略及设备差异性)。不同应用场景的旋转策略呈现与限制可见[旋转接口的行为限制](/consumer/cn/doc/harmonyos-guides/window-rotation#旋转接口的行为限制)。

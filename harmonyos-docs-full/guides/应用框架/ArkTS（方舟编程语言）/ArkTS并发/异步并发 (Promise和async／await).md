...
在上述代码中，then方法的回调函数接收Promise对象的成功结果，并输出至控制台。如果Promise对象进入rejected状态，catch方法的回调函数接收错误对象，并输出至控制台。
  ...
  ![image](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/83/v3/6a4UhDiWQO-DeH-rYgmugA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260420T193723Z&HW-CC-Expire=86400&HW-CC-Sign=F28B34648F8C0F69BF184DC980A5FDDD8EC5A276C73422514AF34AF700A02B59)   

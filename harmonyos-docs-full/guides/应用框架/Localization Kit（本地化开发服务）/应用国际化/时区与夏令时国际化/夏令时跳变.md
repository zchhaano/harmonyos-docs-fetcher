...
```
let calendar : i18n. Calendar = i18n. getCalendar ( 'zh-Hans' ); calendar. setTimeZone ( 'Europe/London' ); calendar. set ( 2021 , 2 , 27 , 16 , 0 , 0 ); // 夏令时开始前的时间 let startTime = calendar. getTimeInMillis (); calendar. set ( 2021 , 2 , 28 , 16 , 0 , 0 ); // 处于夏令时期间的时间 let finishTime = calendar. getTimeInMillis (); let hours = (finishTime - startTime) / ( 3600 * 1000 ); // hours = 23
```
...
### 存储和显示数据
 ...
 ![image](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20260224165829.37560307726283995572638985010603:50001231000000:2800:D3FE6714B844E4F6A95DE21C74FF66C08E85197D7C810189E77875A3F961AE4B.png)

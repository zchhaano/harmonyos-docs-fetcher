...
[LocCrossOriginResAccSol_one.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20251117/ArkWeb/ManageWebCompSecPriv/entry/src/main/ets/pages/LocCrossOriginResAccSol_one.ets#L16-L76) 收起自动换行深色代码主题复制
...
```
const body = document . body ; const element = document . createElement ( 'div' ); element. textContent = 'success' ; body. appendChild (element);
```
...
[LocCrossOriginResAccSol_two.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20251117/ArkWeb/ManageWebCompSecPriv/entry/src/main/ets/pages/LocCrossOriginResAccSol_two.ets#L16-L49) 收起自动换行深色代码主题复制

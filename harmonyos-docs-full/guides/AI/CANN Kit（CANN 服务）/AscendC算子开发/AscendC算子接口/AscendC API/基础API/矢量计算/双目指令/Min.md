...
![image](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20260224165328.00501827097126324174277954957835:50001231000000:2800:4443764EE43C2C19FBCA0B06EAEED68B2AA0EB7AF494586E8C2AA4AE83C02FEE.png)
...
```
template < typename T> __aicore__ inline void Min ( const LocalTensor<T>& dstLocal, const LocalTensor<T>& src0Local, const LocalTensor<T>& src1Local, const int32_t & calCount)
```

...
本样例中只展示Compute流程中的部分代码。如果开发者需要运行样例代码，请将该代码段拷贝并替换[样例模板](/consumer/cn/doc/harmonyos-guides/cannkit-data-createvecindex#zh-cn_topic_0000002105396954_section76120447501)中Compute函数相关代码片段即可。

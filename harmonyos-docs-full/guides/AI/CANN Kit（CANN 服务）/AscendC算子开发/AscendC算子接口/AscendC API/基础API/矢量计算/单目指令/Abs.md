...
![image](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20260224165326.54934666892956952274784398040559:50001231000000:2800:D581236DC3109C28FCC9D4DA8FE7B0CDA366EB1019479492A755A7E2A201D50F.png)
...
如果开发者需要运行样例代码，请将该代码段拷贝并替换[样例模板](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cannkit-vector-calculation-binocular-more#zh-cn_topic_0000002123589629_section11009mcpsimp)中Compute函数的部分代码即可。
 ...
 tensor前n个数据计算接口样例：收起自动换行深色代码主题复制
...
```
输入数据(srcLocal): [0.0 -1.0 2.0 -3.0 ...] 输出数据(dstLocal): [0.0 1.0 2.0 3.0 ...]
```
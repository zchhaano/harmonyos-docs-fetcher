...
![image](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20260224165327.43551061081309502266985379717433:50001231000000:2800:AB238F66D100352C3F4C7671F882CDB82247404966885B03DE22E34A03092C49.png)
...
```
template < typename T> __aicore__ inline void Sqrt ( const LocalTensor<T>& dstLocal, const LocalTensor<T>& srcLocal, const int32_t & calCount)
```
...
```
输入数据(srcLocal): [1.0 2.0 3.0 4.0 ...] 输出数据(dstLocal): [1.0 1.414 1.732 2.0...]
```
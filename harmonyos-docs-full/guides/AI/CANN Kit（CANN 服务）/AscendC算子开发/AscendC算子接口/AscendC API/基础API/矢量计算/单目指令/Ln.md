...
![image](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20260224165325.90072641448073478392783078934047:50001231000000:2800:F44FBD05844E5F27AA5862666A3A391EB4CE0F429541B48644E6E99D73972FB5.png)
...
```
template < typename T> __aicore__ inline void Ln ( const LocalTensor<T>& dstLocal, const LocalTensor<T>& srcLocal, const int32_t & calCount)
```
...
```
输入数据(srcLocal): [1 2 3 4 ...] 输出数据(dstLocal): [0 0.6931 1.0986 1.3863 ...]
```
...
![image](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20260224165325.59785138298476376263382629041057:50001231000000:2800:EAC8A7723455766D3DF3B9FC6E53EBE3F26EBDED11D3D03896450C6C2CB7BE24.png) 说明
...
```
mm. SetTensorA (gm_a); // 设置左矩阵A mm. SetTensorB (gm_b); // 设置右矩阵B mm. SetBias (gm_bias); // 设置Bias mm. SetLocalWorkspace (ubBuf);
```
4. 完成矩阵乘操作。

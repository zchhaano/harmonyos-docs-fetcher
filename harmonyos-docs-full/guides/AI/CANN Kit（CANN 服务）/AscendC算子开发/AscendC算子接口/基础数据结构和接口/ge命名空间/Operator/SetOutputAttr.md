...
```
SetOutputAttr ( const char_t *dst_name, const char_t *name, int64_t attr_value); SetOutputAttr ( const int32_t index, const char_t *name, int64_t attr_value);
```
...
```
GetOutputAttr ( const int32_t index, const char_t *name, int64_t &attr_value) const ; GetOutputAttr ( const char_t *dst_name, const char_t *name, int64_t &attr_value) const ;
```
